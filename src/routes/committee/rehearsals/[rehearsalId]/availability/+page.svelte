		...
		<StructuredListBody>
			...
			{#each availableUsers as userAvailability}
				<StructuredListRow>
					...
					<StructuredListCell
						>{userAvailability.startTime + ' - ' + userAvailability.endtime}</StructuredListCell
					>
				</StructuredListRow>
			{/each}
		</StructuredListBody>
